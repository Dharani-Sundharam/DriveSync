...
: ${AMENT_CURRENT_PREFIX:="/home/dharani/Desktop/V2V/install/differential_drive_robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/differential_drive_robot/environment/pythonpath.sh"
